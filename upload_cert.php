<?php
/**
 * upload_cert.php — Dometriks Engineer Degree Upload
 * 
 * Simple PHP script to receive an engineer's degree certificate (PDF),
 * store it on the server, and return its URL.
 */
...
$baseUrl = 'https://dometriks.com/certificates/';
...
$filename = "cert_{$timestamp}_{$originalName}";
